#THE TOOL CREATED BY Raihan
#FB : https://www.facebook.com/rdxbot11?mibextid=ZbWKwL
#Programer Raihan hosssain
#𝐖𝐇𝐀𝐓'𝐒 𝐀𝐏𝐏 : +8801321064721
W = '\033[97;1m' 
R = '\033[91;1m' 
G = '\033[92;1m' 
Y = '\033[93;1m' 
...
\33[1;32m𝐖𝐞𝐥𝐜𝐨𝐦𝐞 𝐓𝐨 ʀᴀɪʜᴀɴ 𝐇𝐚𝐜𝐤𝐢𝐧𝐠 𝐓𝐨𝐨𝐥𝐬

\33[1;34m✨↦↦↦↦↦✨↦↦↦↦↦✨↦↦↦↦↦✨↦↦↦↦↦✨


╔════════════════════════════════════════╗
║\33[1;32m[↦] 𝙰𝚄𝚃𝙷𝙾𝚁     : RAIHAN HOSSAIN 
║\33[1;32m[↦] 𝙵𝙰𝙲𝙴𝙱𝙾𝙾𝙺   : Raihan hossain
║\33[1;32m[↦] 𝙶𝙸𝚃𝙷𝚄𝙱     : raihanrdx
║\33[1;32m[↦] 𝚆𝚑𝚊𝚝𝚜𝚊𝚙𝚙   : +8801321064721
...
class Main:
	def __init__(self):
		...
		if syed in ["", " "]:
			...
			print("")
			time.sleep(2.0)
			print("\033[1;33m   This Is Raihan")
			print("")
			input("\n\033[1;32m   ENTER MY FACEBOOK NAME  ==> \033[1;36m")
			time.sleep(2.1)
			print("")
			print("\033[1;32m  Successful Bro Please W8...")
			print("\033[1;32m  The Tool Created By Raihan hosssain")
			time.sleep(2.0)
			os.system("clear")
		print(logo)
		print("\033[0;90m╔══════════════════════════════════════════════════════════╗")
		...
		if DEVIL in ["1", "01"]:
			self.fbtua()
		if DEVIL in ["2", "02"]:
			os.system('xdg-open https://github.com/raihanrdx')
		if DEVIL in ["3", "03"]:
			os.system('xdg-open https://www.facebook.com/rdxbot11?mibextid=ZbWKwL/')
		if DEVIL in ["4", "04"]:
			os.system('xdg-open https://www.facebook.com/profile.php?id=100088462695889/')
		if DEVIL in ["5",  "05"]:
			self.old2()
			exit()
		else:
	...
	def fbtua(self):
		...
		try:
			...
			exit("\n\n \033[0;95m>>[PROCESS COMPLETE... \n\033[0;92m >>[Thanks For Using Raihan Tools...")
	...
	def api(self, uid, pwx):
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r  \033[1;32m   [Raihan] %s | %s\033[1;32m         "%(uid, pw))
